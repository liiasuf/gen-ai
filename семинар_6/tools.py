"""
Инструменты макро-агента.
Инструменты 1-5 — базовые (взяты из стартера семинара 5).
Инструмент 6 — compare_periods (домашнее задание).

Стратегия: сначала пробуем живой ЦБ, при ошибке — fallback из CSV в ./data/.
В каждом ответе поле `source` — "cbr_live" | "fallback_csv" | "rosstat_csv".
"""
